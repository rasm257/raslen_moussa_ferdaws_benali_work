...
<body>
    ...
    <div class = "login">
        <h2>Add Student</h2>
        <form method = "post" class = "text-center mb-4" action="add.php">
            ...
            <div class = "form-group">
                ...
                <input type = "date" name = "student_date_naissance" id = "student_date_naissance" class = "form-control" required>
            </div>
            <div class = "form-group">
                <label for = "password">Student Section ID</label>
                <input type = "text" name = "student_section_id" id = "student_section_id" class = "form-control" required>
            </div>
            <button type = "submit" class = "btn btn-primary form-group change" name="AddButton">Add</button>
        </form>
    </div>
    <script>
